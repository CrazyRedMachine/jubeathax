...
com_wflags  := -Wall -Werror -Wpointer-arith -Wreturn-type \
    ...
    -fstrict-aliasing -Wno-unused-function -Wno-unknown-pragmas \
...
modules		:= $(plugindlls) $(dlls) $(exes) $(libs) $(avsdlls) $(avsexes)
...
$$(eval $$(foreach plugindll,$(plugindlls),$$(call t_linkplugindll,$1,indep,$$(plugindll))))
...
define t_linkplugindll

dll_$1_$2_$3	:= $$(bindir_$1_$2)/$3.dll
pluginsrc_$1_$2_$3 := io_plugins/$(srcpp_$3)

$$(dll_$1_$2_$3): $$(abslib_$1_$2_$3) \
                  $$(absdpl_$1_$2_$3) \
		  $$(pluginsrc_$1_$2_$3) | $$(bindir_$1_$2)
	$(ccache) $$(toolchain_$1)g++ -shared -o $$(dll_$1_$2_$3) $$(pluginsrc_$1_$2_$3) $$(ldflags_$3) $(optflags_$1)
	$$(toolchain_$1)strip -s $$(dll_$1_$2_$3)
